...
const CreateListing = () => {
  ...
  const handleImageSubmit = async (e) => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...prev,
        imageUrls: [...prev.imageUrls, ...data.data.imageUrls],
      }));
      setFiles([]);
    } catch (error) {
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <input
            type="number"
            placeholder="Age of Construction (years, optional)"
            className="border p-3 rounded-lg"
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            ...
            <span className="font-normal text-gray-600 ml-2">
              The first image will be the cover (min 2, max 6)
            </span>
          </p>
          <div className="flex gap-4">
            ...
            <button
              type="button"
              disabled={uploading || imageUploadLoading}
              onClick={handleImageSubmit}
              className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80"
            >
              {uploading || imageUploadLoading ? 'Uploading...' : 'Upload'}
            </button>
          </div>
